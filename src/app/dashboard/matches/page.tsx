...
import { Shield, Calendar, ArrowRight, Loader2 } from 'lucide-react'
...
export default function MatchesPage() {
  ...
  const { groupedMatches, isLoading, error } = useMatches()
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-white">GestiÃ³n de Partidos</h1>
